...
function create_custom_post_type()
{
    ...
    /*
     * $label contend text relative to the Post Type in Admin
     */
    $label = array(
        'name' => 'Products', //name post types
        'singular_name' => 'Product' //name post type 
    );
    ...
    $args = array(
        'labels' => $label, 
        'description' => 'Product\'s Post type', //description of post type
        'supports' => array(
            'title',
            'editor',
            'excerpt',
    ...
    register_post_type('product', $args); //create post type with slug is sanpham and $args above
...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Movies1', 'Post Type General Name', 'twentytwentyone' ),
        'singular_name'       => _x( 'Movie', 'Post Type Singular Name', 'twentytwentyone' ),
        'menu_name'           => __( 'Movies1', 'twentytwentyone' ),
...
// Set other options for Custom Post Type
    ...
    register_post_type( 'movies1', $args );
...
class Random_Post extends WP_Widget {
    function __construct() {
        parent::__construct(
            'random_post',
            'Random Posts',
            array( 'description'  =>  'Widget random posts' )
        );
    }
    ...
    function form( $instance ) {
        ...
        echo '<p>Number of posts <input type="number" class="widefat" name="'.$this->get_field_name('post_number').'" value="'.$post_number.'" placeholder="'.$post_number.'" max="30" /></p>';
    ...
    function widget( $args, $instance ) {
        ...
        //create field widget in table wp_options
